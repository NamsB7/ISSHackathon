...
def insert_item():
    ...
    with sqlite3.connect(app.config['DATABASE']) as con:
        ...
        cur.execute('''INSERT INTO items 
                       (item_description, item_name, person_name, person_phone_no, person_email_id, roll_no, item_status)
                       VALUES (?, ?, ?, ?, ?, ?, ?)''',
                    (item_description, item_name, person_name, person_phone_no, person_email_id, roll_no, item_status))
...
def insert_item_F():
    ...
    with sqlite3.connect(app.config['DATABASE']) as con:
        cur = con.cursor()
        cur.execute('''INSERT INTO items 
                       (item_no, item_description, item_name, person_name, person_phone_no, person_email_id, roll_no, item_status)
                       VALUES (?, ?, ?, ?, ?, ?, ?, ?)''',
                    (item_no, item_description, item_name, item_price, person_name, person_phone_no, person_email_id, roll_no, item_status))
